...
for path in ROOT.rglob('*'):
 ...
 for rx,label in blocked:
  ...
  # Generated by the Supabase CLI and drift-checked in CI; its TypeScript `export type Database = {` is not a backend setting.
  if label=='operational backend term' and rel=='web/src/lib/database.types.ts' and not re.search(r'(?i)'+'click'+r'house|ssh\s+|raw storage', text): continue
