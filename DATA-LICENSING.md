# Data licensing and release policy

The MIT licence applies only to original code and documentation authored for this repository. It does **not** relicense third-party data or content.
...
## Moving beyond link-only

A pull request must document: publisher; exact asset; exact licence/permission URL; licence version; attribution; modification and redistribution conditions; privacy/minimisation review; decision date and reviewer. Mixed pages and attachments are reviewed separately. If rights cannot be verified, keep `pending` and link to the publisher.

This policy is cautious project practice, not legal advice.
