...
export const PARLIAMENT_LIVE_SOURCES: SourceConfig[] = [
  ...
  },
  {
    ...
    enabled: false, disabled_because: "cli_only", blocked_reason: "Backfill route: about 1,900 paced requests. Run deliberately from the CLI and resumed from its checkpoint; never scheduled.",
  ...
  },
  {
    ...
    view_scope: "current_parliament", expected_cadence_seconds: 86400, snapshot_semantics: "rolling_window", enabled: false, disabled_because: "pending_person_decision",
  ...
  },
  {
    ...
    snapshot_semantics: "append_only_feed", enabled: false, disabled_because: "publisher_blocked",
