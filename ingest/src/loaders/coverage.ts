...
export const SOURCE_ROUTES: { [sourceId: string]: SourceRoute } = {
  ...
  finance_2023_candidate_return_disclosures_export: { kind: "backfill", state: "built_not_proven", evidence: "reconciled against the warehouse on 2026-09-21 (docs/database/receipts/2026-09-21-election-donations.export.json); the combined manifest does not yet name it" },
  finance_2025_party_return_disclosures_export: { kind: "backfill", state: "built_not_proven", evidence: "reconciled against the warehouse on 2026-09-21 (docs/database/receipts/2026-09-21-election-donations.export.json); the combined manifest does not yet name it" },
